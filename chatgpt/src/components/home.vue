...
// 注意以下apikey为测试key，不可用于生产环境，如需使用请自行申请
// 请注意，本vue文件为urban-gpt项目的核心文件，对其中一些敏感数据进行了删除和修改，真实项目与此文件可能存在差异
// 为了保护一些私有数据，我们对一些敏感数据进行了删除和修改，真实项目与此文件可能存在差异
let apiKey = "sk-xxxxxxxxxx";
...
const messageList = ref<ChatMessage[]>([
	{
		role: "system",
		content:
		"欢迎使用基于gpt-3.5-turbo大语言模型的智慧城市助手，我可以提供一些常用服务和信息，例如：",
	},
	{
		role: "assistant",
